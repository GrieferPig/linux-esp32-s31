...
asmlinkage __visible void smp_callin(void)
{
	 ...
	 */
	pr_info("S31 SMP: cpu%u enabling local IRQs sintstatus=%#lx\n",
		curr_cpuid, csr_read(0xdb1));
	local_irq_enable();
	pr_info("S31 SMP: cpu%u local IRQs enabled, entering CPUHP idle sintstatus=%#lx\n",
		curr_cpuid, csr_read(0xdb1));
